"""
test.py — Runnable demo/test script for nndbg.

Run with:
    python test.py

Toggle verbose output, probe type, and save path at the top of this file.
"""
...
VERBOSE = True
PROBE_TYPE = "logistic"
SAVE_PATH = "results.zip"

nndbg.set_verbose(VERBOSE)
...
results.summary(top_k=None)

if SAVE_PATH:
    path = results.save(SAVE_PATH)
    print(f"\nSaved → {path}")